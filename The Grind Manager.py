...
Ent1 = Entry(window, bd=2, justify="center", bg="orange")
Ent1.grid(row=0, column=0)
Ent1.insert(0, "row 0, column 0")

Ent2 = Entry(window, bd=2, justify="center", bg="orange")
Ent2.grid(row=0, column=1)
Ent2.insert(0, "row 0, column 1")

Ent3 = Entry(window, bd=2, justify="center", bg="orange")
...
Ent5 = Entry(window, bd=2, justify="center", bg="purple")
Ent5.grid(row=1, column=1)
Ent5.insert(0, "row 1, column 1")

Ent6 = Entry(window, bd=2, justify="center", bg="lavender")
...
Ent9 = Entry(window, bd=2, justify="center", bg="cyan")
